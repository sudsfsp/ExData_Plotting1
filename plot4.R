...
grDevices::png(filename = "./plot4.png", width = 480, height = 480)
par (mfrow= c(2,2))
plot(graphData$DateTime, graphData$Global_active_power/1000,type = "l", xlab="",ylab = "Global Active Power")

plot(graphData$DateTime, graphData$Voltage/1000, type =  "l", xlab="datetime",ylab = "Voltage")
ab <-  graphData %>% gather(class, value, Sub_metering_1:Sub_metering_3) ## gather all values of sub_metering
x <- ab$DateTime
y <- ab$value/1000
...
plot(graphData$DateTime, graphData$Global_reactive_power/1000,type = "l", xlab="datetime",ylab = "Global_reactive_power")
